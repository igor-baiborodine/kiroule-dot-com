...
While the transition to S3 and PostgreSQL addressed the stateful requirements of the "shift," the final hurdles involved the networking and runtime behavior of the services themselves. Moving from the flat network of Docker Compose to the segmented, DNS-heavy environment of Kind and K3s surfaced several edge cases where the legacy configuration simply didn't translate.
